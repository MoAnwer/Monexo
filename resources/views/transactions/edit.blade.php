...
<html
  ...
  <body>
                  ...
                  <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                    ...
                    <div>
                          ...
                          <div class="col mb-2 mt-4">
                            <div class="form-floating form-floating-outline">
                              <input
                                ...
                                class="form-control"
                                name="amount"
                                value="{{ round($transaction->amount) }}"
                                placeholder="000.00" />
                      ...
                      <div class="row g-2">
                        <div class="col mb-2">
                          <div class="form-floating form-floating-outline">
                            <input type="date" id="editdateBackdrop" class="form-control"  name="date" value="{{ $transaction->date }}"/>
                          ...
                          <div class="form-floating form-floating-outline">
                            <select class="form-select" name="type" id="edittypeBackdrop">
                              @foreach(['income', 'expense'] as $type)
                                <option value="{{ $type }}" @selected($type == $transaction->type)>
                                  {{ $type }}
                                </option>
                                @break
                              @endforeach
                        ...
                        <div class="col mb-2">
                          <div class="form-floating form-floating-outline">
                            <select class="form-select" id="editcategoryBackdrop" name="category">
                              <option value="{{ $transaction->cateogry }}">{{$transaction->cateogry}}</option>
                        ...
                        <div class="row g-4">
                          <div class="col mb-2">
                            <div class="form-floating form-floating-outline">
                              <textarea name="description" id="editdescription" cols="30" rows="10" class="form-control">{{ $transaction->description }}</textarea>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <script src="{{ url('assets/') }}/js/pages/transactions.js"></script>
